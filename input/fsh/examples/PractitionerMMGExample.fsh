...
* address.city[0] = "Roma"
* address.city[0].extension[codiceComune].valueCoding = $cs-istat-comune#058091 "Roma"
...
* address.country[0].extension[codiceStato].valueCoding = $cs-istat-statoNascita#100 "Italia"
